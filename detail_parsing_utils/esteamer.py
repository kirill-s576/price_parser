...
class Esteamer(object):
    def __init__(self):
        # Переменные магазина
        self.www = "https://esteamer.by/"
        ...
        self.name_regexp = r'<h1 itemprop="name" class="product_title entry-title">(.*?)</h1>'
        self.price_regexp = r'<meta itemprop="price" content="(.*?)" />'
        self.available_regexp = r'<link itemprop="availability" href="http://schema.org/(.*?)" />'
        self.fullprice_regexp = r''
        self.imageurl_regexp = r'<div class="images">.*?<a href="(.*?)" itemprop="image" class="img-responsive woocommerce-main-image zoom"'
